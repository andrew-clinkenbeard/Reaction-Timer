...
HD_PWD='C:/Users/andrew_clinkenbeard1/Box/SOC/Class-Assignment-2/Reaction Timer/Reaction Timer.runs/synth_1'
cd "$HD_PWD"
...
EAStep vivado -log state.vds -m64 -product Vivado -mode batch -messageDb vivado.pb -notrace -source state.tcl
