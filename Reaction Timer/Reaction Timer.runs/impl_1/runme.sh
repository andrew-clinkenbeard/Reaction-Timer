...
HD_PWD='C:/Users/andrew_clinkenbeard1/Box/SOC/Class-Assignment-2/Reaction Timer/Reaction Timer.runs/impl_1'
cd "$HD_PWD"
...
EAStep vivado -log state.vdi -applog -m64 -product Vivado -messageDb vivado.pb -mode batch -source state.tcl -notrace
